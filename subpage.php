...
if(isset($_POST['submit'])){
  if(isset($_POST['transaction_id'])){
    ...
    $patname=$_SESSION['patient_name'];
    $query="UPDATE docpayment SET transaction_id = '$trans' WHERE patient_name ='$patname'";
      ...
      <section id="testimonials" class="testimonials">
        <div class="container">
          ...
          <center><h1>Payment Details</h1>
            ...
            <input type="tel" name="transaction_id"  placeholder=" UPI Transaction id" id="trans" required></center>
